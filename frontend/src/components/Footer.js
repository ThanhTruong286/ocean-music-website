...
const Footer = () => {
    ...
    return (
        <footer className="footer">
            <ReactAudioPlayer
                ref={audioRef}
                src="your-audio-source.mp3" // Replace with your audio source
                autoPlay
                onTimeUpdate={() => setCurrentTime(audioRef.current.currentTime)} // Update current time
            />
                ...
                <div className="row">
                    <div className="col-12">
                        <input
                            ...
                            onChange={handleSeekChange} // Use onChange for handling seek
                        />
                                ...
                                <div className="col-lg-4 col-md-5 col-sm-4 col-4">
                                    <div className="track-volumne d-flex align-items-center justify-content-md-end justify-content-sm-start justify-content-center">
                                        ...
                                        <input
                                            ...
                                            value={volume}
                                            className="seek_slider"
                                            onChange={handleVolumeChange} // Use onChange for handling volume
                                        />
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-5 col-sm-4 col-5">
                                    <div className="track-time text-center">
                                        <span className="current-time text-white small">00:06</span>
                                        ...
                                        <span className="total-duration text-white small">00:27</span>
                                    </div>
                                </div>
