                        ...
                        <div class="row">
                                        ...
                                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                                            <div class="d-flex flex-wrap align-items-center">
                                                <div class="profile-img position-relative me-3 mb-3 mb-lg-0 profile-logo profile-logo1">
                                                    <img src={faker} alt="User-Profile" class="theme-color-default-img img-fluid rounded-pill avatar-100" loading="lazy" />
                                                </div>
                                                <div class="d-flex flex-wrap align-items-center mb-3 mb-sm-0">
                                                    <h4 id="fullname" class="me-2 h4">LEE SANG-HYEOK - <span>Mid Lane</span></h4>
                                                </div>
                                            </div>
                                            <ul class="d-flex nav nav-pills mb-0 text-center profile-tab nav-slider" data-toggle="slider-tab" id="profile-pills-tab" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <a class="nav-link show" data-bs-toggle="tab" href="#profile-feed" role="tab" aria-selected="false" tabindex="-1">Feed</a>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <a class="nav-link active" data-bs-toggle="tab" href="#profile-profile" role="tab" aria-selected="true">Profile</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-grid gap-card grid-cols-3">
                                            <a data-fslightbox="gallery" href="../../assets/images/dashboard/38.png">
                                                <img src="../../assets/images/dashboard/38.png" class="img-fluid  rounded" alt="profile-image" loading="lazy" />
                                            </a>
                                            <a data-fslightbox="gallery" href="../../assets/images/dashboard/39.png">
                                                <img src="../../assets/images/dashboard/39.png" class="img-fluid  rounded" alt="profile-image" loading="lazy" />
                                            </a>
                                            <a data-fslightbox="gallery" href="../../assets/images/dashboard/40.png">
                                                <img src="../../assets/images/dashboard/40.png" class="img-fluid  rounded" alt="profile-image" loading="lazy" />
                                            </a>
                                            <a data-fslightbox="gallery" href="../../assets/images/dashboard/41.png">
                                                <img src="../../assets/images/dashboard/41.png" class="img-fluid  rounded" alt="profile-image" loading="lazy" />
                                            </a>
                                            <a data-fslightbox="gallery" href="../../assets/images/dashboard/42.png">
                                                <img src="../../assets/images/dashboard/42.png" class="img-fluid  rounded" alt="profile-image" loading="lazy" />
                                            </a>
                                            <a data-fslightbox="gallery" href="../../assets/images/dashboard/43.png">
                                                <img src="../../assets/images/dashboard/43.png" class="img-fluid  rounded" alt="profile-image" loading="lazy" />
                                            </a>
                                            <a data-fslightbox="gallery" href="../../assets/images/dashboard/44.png">
                                                <img src="../../assets/images/dashboard/44.png" class="img-fluid rounded" alt="profile-image" loading="lazy" />
                                            </a>
                                            <a data-fslightbox="gallery" href="../../assets/images/dashboard/32.png">
                                                <img src="../../assets/images/dashboard/32.png" class="img-fluid rounded" alt="profile-image" loading="lazy" />
                                            </a>
                                            <a data-fslightbox="gallery" href="../../assets/images/dashboard/31.png">
                                                <img src="../../assets/images/dashboard/31.png" class="img-fluid rounded" alt="profile-image" loading="lazy" />
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="twit-feed">
                                            <div class="d-flex align-items-center mb-2">
                                                <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-danger ps-2" src="../../assets/images/dashboard/56.png" alt="" loading="lazy" />
                                        ...
                                        <div class="twit-feed">
                                            <div class="d-flex align-items-center mb-2">
                                                <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-primary" src="../../assets/images/dashboard/55.png" alt="" loading="lazy" />
                                                <div class="media-support-info">
                                        ...
                                        <div class="twit-feed">
                                            <div class="d-flex align-items-center mb-2">
                                                <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-warning pt-2" src="../../assets/images/dashboard/56.png" alt="" loading="lazy" />
                                                <div class="mt-2">
                            ...
                            <div class="col-lg-6">
                                <div class="profile-content tab-content iq-tab-fade-up">
                                    <div id="profile-feed" class="tab-pane fade" role="tabpanel">
                                    </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="text-center">
                                                    <div>
                                                        <img src={peanut} alt="profile-img" class="rounded-pill avatar-130 img-fluid" loading="lazy" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <h3 class="d-inline-block" id="fullname">WANG-HO - <span>Jungle</span></h3>
                            ...
                            <div class="col-lg-3">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p>I'm MidKing</p>
                                        <div class="mb-1">Email: <a href="#" class="ms-3">peanut@gmail.com</a></div>
                                    ...
                                    <div class="card-body">
                                        <ul class="list-inline m-0 p-0">
                                            <li class="d-flex mb-4 align-items-center active">
                                                <img src={faker} alt="story-img" class="rounded-pill avatar-70 p-1 border bg-soft-light img-fluid" loading="lazy" />
                                                <div class="ms-3">
                                                    <h5>User 1</h5>
                                            ...
                                            <li class="d-flex mb-4 align-items-center">
                                                <img src={faker} alt="story-img" class="rounded-pill avatar-70 p-1 border img-fluid bg-soft-danger" loading="lazy" />
                                                <div class="ms-3">
                                                    <h5>User 2</h5>
                                            ...
                                            <li class="d-flex align-items-center">
                                                <img src={faker} alt="story-img" class="rounded-pill avatar-70 p-1 border bg-soft-primary img-fluid" loading="lazy" />
                                                <div class="ms-3">
                                                    <h5>User 3</h5>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-inline m-0 p-0">
                                            <li class="d-flex mb-4 align-items-center">
                                                <div class="img-fluid bg-soft-info rounded-pill"><img src={faker} alt="story-img" class="rounded-pill avatar-40" loading="lazy" /></div>
