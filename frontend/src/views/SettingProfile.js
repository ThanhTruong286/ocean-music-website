import React, { useState, useEffect } from "react"; // Sửa lỗi useState và useEffect
import Header from "../components/Header"; // Sửa lỗi Header
import Sidebar from "../components/Sidebar"; // Sửa lỗi Sidebar
import Footer from "../components/Footer"; // Sửa lỗi Footer
import ProfileModal from "../components/ProfileModal"; // Sửa lỗi ProfileModal
import { fetchArtists } from "../api/api"; // Sửa lỗi fetchArtists
import "../styles/profile.scss"; // CSS liên quan đến profile
